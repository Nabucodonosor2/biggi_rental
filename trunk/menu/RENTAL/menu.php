...
$ventas = array(new item_menu('Cotización', '1505', "../../../commonlib/trunk/php/mantenedor.php?modulo=cotizacion&cod_item_menu=1505"),
				...
				new item_menu('OCI Para Rental', '1560', "../../../commonlib/trunk/php/mantenedor.php?modulo=orden_compra_interna&cod_item_menu=1560")
				);
			
$arriendo = array(new item_menu('Cotización Arriendo', '2005', "../../../commonlib/trunk/php/mantenedor.php?modulo=cot_arriendo&cod_item_menu=2005")
				,new item_menu('-')
                ...
                ,new item_menu('Arriendos por facturar', '2036', "../../../commonlib/trunk/php/mantenedor.php?modulo=arr_x_facturar&cod_item_menu=2036")
				,new item_menu('-')
