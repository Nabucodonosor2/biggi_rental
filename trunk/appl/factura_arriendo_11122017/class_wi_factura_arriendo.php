...
class wi_factura_arriendo extends wi_factura {
	...
	function load_record() {
		...
		// nada modificable a exepcion de la OC en algunos cod_empresa
		if($this->dws['dw_factura']->get_item(0, 'COD_EMPRESA') == 99 or $this->dws['dw_factura']->get_item(0, 'COD_EMPRESA') == 5 or $this->dws['dw_factura']->get_item(0, 'COD_EMPRESA') == 7){	//CASINO EXPRESS S.A. o  COMPASS SERVICIOS S.A 
