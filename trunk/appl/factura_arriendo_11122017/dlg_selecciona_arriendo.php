...
$sql = "select null COD_EMPRESA
				...
				,null NOM_EMPRESA
				,null SUMA_TOTAL
				,convert(varchar(20),getdate(),103) FECHA_STOCK ";
...
$dw_empresa->add_control($control = new edit_date('FECHA_STOCK'));
$control->set_onChange('valida_fecha();');

$dw_empresa->insert_row();
$dw_empresa->set_item(0, 'FECHA_STOCK', $dw_empresa->current_date());
