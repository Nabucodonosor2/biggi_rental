...
class wo_factura_arriendo extends w_output_biggi {
	...
	function habilita_boton(&$temp, $boton, $habilita) {
		if ($boton=='add') {
			...
			if ($habilita){
				$ruta_over = "'../../images_appl/b_dte_over.jpg'";
				$ruta_out = "'../../images_appl/b_dte.jpg'";
				$ruta_click = "'../../images_appl/b_dte_click.jpg'";
				$temp->setVar("WO_PRINT_DTE", '<input name="b_'.$boton.'" id="b_'.$boton.'" type="button" onmouseover="entrada(this, '.$ruta_over.')" onmouseout="salida(this, '.$ruta_out.')" onmousedown="down(this, '.$ruta_click.')"'.
												 'style="cursor:pointer;height:68px;width:66px;border: 0;background-image:url('.$ruta_out.');background-repeat:no-repeat;background-position:center;border-radius: 15px;"'.
