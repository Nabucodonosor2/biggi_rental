...
class dw_orden_compra extends dw_help_empresa {
	...
	function dw_orden_compra() {	
		...
		////////////////////
		// tab orden_compra
		parent::dw_help_empresa($sql, '', false, false, 'P');	// El ï¿½ltimo parametro indica que solo acepta proveedores
        ...
        //que no se pueda modificar mas alla de un % (de parï¿½metro = 20 % incial)
...
class wi_orden_compra_base extends w_cot_nv {
	...
	function new_record() {
		...
		//*** el 1er tab no aparece el nom_estado... ï¿½lo dejamos asi?
	...
	function load_record() {
		...
		//privilegio que se pueda modificar mas alla de un % (de parï¿½metro = 20 % incial) 
