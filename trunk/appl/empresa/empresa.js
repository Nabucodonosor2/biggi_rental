function valida_check(ve_control){
	...
	if(vl_nom_field == 'REFERENCIA_HEM')
		document.getElementById('REFERENCIA_HES_0').checked = false;
	else if(vl_nom_field == 'REFERENCIA_HES')	
		document.getElementById('REFERENCIA_HEM_0').checked = false;
}
...
/**
esta función se reimplementa ya que al agregar productos en tab "Lista de Precio", el precio queda con formato 
