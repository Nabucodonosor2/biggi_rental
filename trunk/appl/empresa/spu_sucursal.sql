-------------------- spu_sucursal ---------------------------------
ALTER PROCEDURE [dbo].[spu_sucursal](@ve_operacion varchar(20),@ve_cod_sucursal numeric ,@ve_nom_sucursal varchar(100)=NULL, @ve_cod_empresa numeric=NULL, @ve_direccion varchar(100)=NULL, @ve_cod_comuna numeric=NULL, @ve_cod_ciudad numeric=NULL, @ve_cod_pais numeric=NULL, @ve_direccion_factura varchar(1)=NULL, @ve_direccion_despacho varchar(1)=NULL, @ve_telefono varchar(100)=NULL, @ve_fax varchar(100)=NULL)
AS
BEGIN
