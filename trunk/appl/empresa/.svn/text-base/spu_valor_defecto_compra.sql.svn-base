...
ALTER PROCEDURE [dbo].[spu_valor_defecto_compra](@ve_operacion varchar(20), @ve_cod_empresa numeric, @ve_cod_persona numeric=NULL, @ve_cod_forma_pago numeric=NULL)
AS
BEGIN	
