-------------------- spu_persona ---------------------------------
ALTER PROCEDURE [dbo].[spu_persona](@ve_operacion varchar(20),@ve_cod_persona numeric, @ve_cod_sucursal numeric=NULL, @ve_nom_persona varchar(100)=NULL, @ve_cod_cargo numeric=NULL, @ve_telefono varchar(100)=NULL, @ve_fax varchar(100)=NULL, @ve_email varchar(100)=NULL)
AS
BEGIN
