...
ALTER PROCEDURE [dbo].[spu_empresa](@ve_operacion varchar(30)
							...
							,@ve_alias_contable varchar(30) = null
							...
							,@ve_tipo_participacion varchar(5) = null
							,@ve_dscto_proveedor T_PORCENTAJE = null
							,@ve_cod_forma_pago_cliente numeric = null
							,@ve_monto_compra_max_sin_autorizar numeric = null
							,@ve_referencia_hem varchar(1) = null
							,@ve_referencia_hes varchar(1) = null) 
AS
BEGIN
...
Declare @cod_empresa_creada numeric
	...
	if (@ve_operacion='INSERT') 
		begin
			insert into empresa (rut, dig_verif, alias, alias_contable, nom_empresa, giro, cod_clasif_empresa, direccion_internet, rut_representante, dig_verif_representante, nom_representante, es_cliente, es_proveedor_interno, es_proveedor_externo, es_personal, imprimir_emp_mas_suc, sujeto_a_aprobacion, cod_usuario, tipo_participacion,dscto_proveedor,cod_forma_pago_cliente, monto_compra_max_sin_autorizar, referencia_hem, referencia_hes)
			values (@ve_rut, upper(@ve_dig_verif), @ve_alias, @ve_alias_contable, @ve_nom_empresa, @ve_giro, @ve_cod_clasif_empresa, @ve_direccion_internet, @ve_rut_representante, @ve_dig_verif_representante, @ve_nom_representante, @ve_es_cliente, @ve_es_proveedor_interno, @ve_es_proveedor_externo, @ve_es_personal, @ve_imprimir_emp_mas_suc, @ve_sujeto_a_aprobacion, @ve_cod_usuario, @ve_tipo_participacion,@ve_dscto_proveedor,3, @ve_monto_compra_max_sin_autorizar, @ve_referencia_hem, @ve_referencia_hes)
		end
		...
		begin
			...
			set rut = @ve_rut, 
				...
				alias = @ve_alias, 
				alias_contable = @ve_alias_contable,
				...
				cod_forma_pago_cliente = @ve_cod_forma_pago_cliente,
				monto_compra_max_sin_autorizar = @ve_monto_compra_max_sin_autorizar,
				referencia_hem = @ve_referencia_hem,
				referencia_hes = @ve_referencia_hes
