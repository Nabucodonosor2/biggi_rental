...
$cod_cot_arriendo = $_REQUEST['cod_cot_arriendo'];

$temp = new Template_appl('../common_appl/que_precio_usa.htm');	
...
$sql = "select  I.ITEM,
								...
								I.NOM_PRODUCTO,
								I.PRECIO,
								P.PRECIO_ARRIENDO_PUBLICO
			  FROM ITEM_COT_ARRIENDO I, PRODUCTO P
			  WHERE I.COD_COT_ARRIENDO = $cod_cot_arriendo AND
			  			P.COD_PRODUCTO = I.COD_PRODUCTO AND
			  			I.PRECIO <> P.PRECIO_ARRIENDO_PUBLICO AND
			  			P.PRECIO_LIBRE = 'N'";
...
for($i=0; $i<count($result); $i++){						
	...
	$temp->setVar("PRODUCTO.PRECIO_ARRIENDO_PUBLICO", number_format($result[$i]['PRECIO_ARRIENDO_PUBLICO'], 0, ',', '.'));
}
