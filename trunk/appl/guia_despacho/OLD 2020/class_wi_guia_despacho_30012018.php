...
class wi_guia_despacho extends w_input {
			...
			for ($i=0 ; $i < $cant_gd_a_hacer; $i++) {
				...
				if ($db->EXECUTE_SP($sp, $param)) {
					...
					$sql= "SELECT GD.COD_GUIA_DESPACHO ,
						...
						$rpt = new print_guia_despacho($sql, $file_name, $labels, "Guï¿½a Despacho ".$cod_guia_despacho.".pdf", 0);
	...
	function enviar_dte(){
		...
		$a['Encabezado']['IdDoc']['Folio']			= $nro_guia_despacho; //el folio lo da el sistema del doc.
