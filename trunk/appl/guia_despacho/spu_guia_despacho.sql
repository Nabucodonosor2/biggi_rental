...
BEGIN  
		declare		@vl_cod_estado_gd_emitida numeric,
					...
					,@vl_cod_tipo_guia_despacho	numeric
		...
		if (@ve_operacion='UPDATE') 
			...
			begin
				...
				begin
					...
					if (@vl_nro_guia_despacho is null)
						begin
							...
							--realiza los cambios necesarios si la GD es de RENTAL
							select @vl_cod_tipo_guia_despacho = COD_TIPO_GUIA_DESPACHO		
							from GUIA_DESPACHO	
							where  cod_guia_despacho = @ve_cod_guia_despacho
							if (@vl_cod_tipo_guia_despacho = 5)	-- ARRIENDO
								exec spu_guia_despacho 'RENTAL', @ve_cod_guia_despacho
				...
				select @vl_cod_tipo_guia_despacho = COD_TIPO_GUIA_DESPACHO		
						...
						,@vl_cod_usuario = COD_USUARIO_IMPRESION
				from GUIA_DESPACHO	
				where  cod_guia_despacho = @ve_cod_guia_despacho
                ...
                exec spu_entrada_bodega 'INSERT', null, @vl_cod_usuario, @vl_cod_bodega, 'GUIA_DESPACHO', @ve_cod_guia_despacho, @vl_referencia
				...
				select @vl_new_cod_entrada_bodega
					,i.ORDEN
					,i.ITEM
					,i.COD_PRODUCTO
					,i.NOM_PRODUCTO
                ...
                where i.COD_GUIA_DESPACHO = @ve_cod_guia_despacho
			end
