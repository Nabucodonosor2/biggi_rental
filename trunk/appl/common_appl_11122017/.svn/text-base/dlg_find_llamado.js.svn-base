function dlg_find_llamado() {
	 var args = "location:no;dialogLeft:200px;dialogTop:100px;dialogWidth:730px;dialogHeight:400px;dialogLocation:0;Toolbar:no;";
	 var returnVal = window.showModalDialog("../common_appl/dlg_find_llamado.php","_blank",args);
