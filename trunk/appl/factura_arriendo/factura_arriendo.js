function dlg_print_dte_wo(ve_control){
...
function dlg_print_dte_masivo(ve_cod_facturas){
	var ve_cant_fact_tot = ve_cod_facturas.split(',');
	var url = "dlg_print_dte_masivo.php?ve_cant_fact_tot="+ve_cant_fact_tot.length;
	$.showModalDialog({
		 url: url,
		 dialogArguments: '',
		 height: 250,
