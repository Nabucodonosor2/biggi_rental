function select_1_empresa(valores, record) {
	...
	var cathering = 'N';
	var marca_catering = document.getElementById('con_caterin');
	if (marca_catering.checked)
		cathering = 'S'
	...
	ajax = nuevoAjax();
	ajax.open("GET", "ajax_load_arriendo.php?cod_empresa=" + vl_cod_empresa+"&fecha_stock="+vl_fecha_stock+"&cathering="+cathering, false);
	ajax.send(null);  
