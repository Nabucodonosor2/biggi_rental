...
class wi_nota_credito_base extends w_cot_nv {
	...
	function enviar_dte(){
		...
		if($revision_estado <> 'EPR' && $revision_estado <> 'RPR' && $revision_estado <> 'RLV' && $COD_FACTURA > 7021){//ultima factura signature cod_factura 7021
			$this->_load_record();
		...
		$a['Encabezado']['IdDoc']['Folio']			= substr($nro_nota_credito, 0, 10); //el folio lo otrorga el sistema
