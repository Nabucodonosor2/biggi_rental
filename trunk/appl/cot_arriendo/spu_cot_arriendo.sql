CREATE PROCEDURE [dbo].[spu_cot_arriendo](@ve_operacion						varchar(20)
...
BEGIN
	if (@ve_operacion='UPDATE')begin
		...
		WHERE cod_cot_arriendo = @ve_cod_cot_arriendo
	end
	else if (@ve_operacion='INSERT') 
		begin
			insert into COT_ARRIENDO
			...
			values 
				...
				,@ve_nro_meses
				,@ve_porc_arriendo
				,@ve_porc_adicional_recuperacion
				,@ve_monto_adicional_recuperacion)
	end
	...
	begin
		...
		select @vl_sub_total = isnull(sum(round(cantidad * precio_arriendo, 0)), 0)
