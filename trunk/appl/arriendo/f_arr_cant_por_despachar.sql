...
alter FUNCTION f_arr_cant_por_despachar(@ve_cod_item_mod_arriendo numeric, @ve_filtro varchar(20)=NULL)
RETURNS T_CANTIDAD 
AS
BEGIN
	...
	where igd.cod_item_doc = @ve_cod_item_mod_arriendo and
		  igd.tipo_doc = 'ITEM_MOD_ARRIENDO' and
