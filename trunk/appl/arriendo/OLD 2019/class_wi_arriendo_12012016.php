...
class wi_arriendo extends w_cot_nv {
	...
	function creada_desde_cot_arr($cod_cot_arriendo){
		...
		if($day_registro_cot > $validez_oferta_cot){
			$this->alert("La Cotización de arriendo Nº ".$cod_cot_arriendo.", se encuentra fuera del periodo de validez de oferta (".$validez_oferta_cot." días.) Se usarán precios actualizados.");
			$no_valido = true;
