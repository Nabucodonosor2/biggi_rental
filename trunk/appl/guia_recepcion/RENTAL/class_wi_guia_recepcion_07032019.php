...
class dw_guia_recepcion extends dw_guia_recepcion_base{
	...
	function dw_guia_recepcion() {
		$sql = "SELECT	GR.COD_GUIA_RECEPCION 
				...
				FROM	GUIA_RECEPCION GR LEFT OUTER JOIN MOD_ARRIENDO M ON M.COD_MOD_ARRIENDO = GR.COD_DOC
						,EMPRESA E,ESTADO_GUIA_RECEPCION EGR, TIPO_GUIA_RECEPCION TGR, USUARIO U
		...
		$this->add_control(new static_text('COD_MOD_ARRIENDO'));
		$this->add_control(new static_text('FECHA_MOD_ARRIENDO'));
		$this->add_control(new static_text('TIPO_DOC_ARRIENDO'));
