...
class wi_ingreso_pago_base extends w_input {
	...
	function envio_mail(){
		...
		$sql = "SELECT U.NOM_USUARIO
				...
				AND E1.COD_EMPRESA = F.COD_EMPRESA";
		...
		$lista_mail_cc = "icampos@integrasystem.cl;evergara@integrasystem.cl";
		$lista_mail_cc_name = "Israel Campos;Erick Vergara";
