...
class wi_producto extends wi_producto_base {
	...
	function wi_producto($cod_item_menu) {
		...
		$sql = "select   P.COD_PRODUCTO COD_PRODUCTO_PRINCIPAL 
                        ...
                        ,PRECIO_ARRIENDO_PUBLICO
                        ,PRECIO_ARRIENDO_PUBLICO  PRECIO_ARRIENDO_PUBLICO_H
                        , null ARRIENDO_2_PORC
                        , null ARRIENDO_3_PORC
                        , null ARRIENDO_4_PORC
                        , null ARRIENDO_5_PORC
                        , null ARRIENDO_6_PORC
                        , null ARRIENDO_7_PORC
                        , null ARRIENDO_8_PORC
                        , null ARRIENDO_9_PORC
                        , null ARRIENDO_10_PORC
                        , null ARRIENDO_11_PORC
                        , null ARRIENDO_12_PORC
                        , null ARRIENDO_13_PORC
        from   			PRODUCTO P
        				,MARCA M
        				,TIPO_PRODUCTO TP
        				,PRODUCTO_LOCAL PL
		...
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_2_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_3_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_4_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_5_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_6_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_7_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_8_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_9_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_10_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_11_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_12_PORC'));	
		$this->dws['dw_producto']->add_control(new static_text('ARRIENDO_13_PORC'));	
		...
		$control->set_onBlur("calc_precio_int_pub();");	
		$this->dws['dw_producto']->add_control(new edit_num('PRECIO_ARRIENDO_PUBLICO'));
		$this->dws['dw_producto']->add_control(new edit_text_hidden('PRECIO_ARRIENDO_PUBLICO_H',10, 10, 'hidden'));
		...
		$this->add_auditoria('PRECIO_ARRIENDO_PUBLICO');
	}
}
