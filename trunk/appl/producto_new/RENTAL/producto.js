...
function porcentaje_arriendo(){
	
	 var precio_arriendo= Number(document.getElementById('PRECIO_ARRIENDO_PUBLICO_H_0').value);
	 
	 document.getElementById('ARRIENDO_2_PORC_0').innerHTML= number_format(precio_arriendo*2/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_3_PORC_0').innerHTML= number_format(precio_arriendo*3/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_4_PORC_0').innerHTML= number_format(precio_arriendo*4/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_5_PORC_0').innerHTML= number_format(precio_arriendo*5/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_6_PORC_0').innerHTML= number_format(precio_arriendo*6/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_7_PORC_0').innerHTML= number_format(precio_arriendo*7/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_8_PORC_0').innerHTML= number_format(precio_arriendo*8/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_9_PORC_0').innerHTML= number_format(precio_arriendo*9/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_10_PORC_0').innerHTML= number_format(precio_arriendo*10/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_11_PORC_0').innerHTML= number_format(precio_arriendo*11/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_12_PORC_0').innerHTML= number_format(precio_arriendo*12/100, 0, ',', '.');
	 document.getElementById('ARRIENDO_13_PORC_0').innerHTML= number_format(precio_arriendo*13/100, 0, ',', '.');
}
