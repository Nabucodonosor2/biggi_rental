--------------------  f_bodega_stock  ----------------
ALTER FUNCTION [dbo].[f_bodega_stock](@ve_cod_producto varchar(20), @ve_cod_bodega numeric, @ve_fecha datetime)
...
/*
-- MH 06022023 SE INDICA DESACTIVAR ESTA PARTE DE LA FUNCION PUES EN RENTAL NO SE USA ESTE MODULO
...
SELECT 	 @cant_inicial = cantidad_cierre
FROM	cierre_bodega
WHERE  	cod_bodega = @ve_cod_bodega and
      	cod_producto = @ve_cod_producto and
...
SET @stock_total = @cant_inicial + @cant_bod_E - @cant_bod_S
